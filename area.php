...
$w = empty($_POST['home_width']);
$b = empty($_POST['home_breadth']);
...
<body>
    ...
    <header class=" flex gap-5  items-center mb-6">
        ...
        <section class=" bg-gray-100 p-10 rounded-lg">
           ...
           <p class="text-4xl text-center mb-5">
                <?php
                    if ($w || $b) {
                        die('value missing!');
                    }
